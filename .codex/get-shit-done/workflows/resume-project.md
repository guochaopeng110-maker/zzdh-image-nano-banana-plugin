...
<required_reading>
@F:/Projects/zz-image-plugins/.codex/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "F:/Projects/zz-image-plugins/.codex/get-shit-done/bin/gsd-tools.cjs" init resume)

...
Use template from `F:/Projects/zz-image-plugins/.codex/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `F:/Projects/zz-image-plugins/.codex/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "F:/Projects/zz-image-plugins/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```

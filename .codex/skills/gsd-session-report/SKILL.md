...
<execution_context>
@F:/Projects/zz-image-plugins/.codex/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @F:/Projects/zz-image-plugins/.codex/get-shit-done/workflows/session-report.md end-to-end.
</process>

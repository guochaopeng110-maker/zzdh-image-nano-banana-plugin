...
<execution_context>
@F:/Projects/zz-image-plugins/.codex/get-shit-done/workflows/check-todos.md
</execution_context>
...
<process>
**Follow the check-todos workflow** from `@F:/Projects/zz-image-plugins/.codex/get-shit-done/workflows/check-todos.md`.

...
<execution_context>
@F:/Projects/zz-image-plugins/.codex/get-shit-done/workflows/add-todo.md
</execution_context>
...
<process>
**Follow the add-todo workflow** from `@F:/Projects/zz-image-plugins/.codex/get-shit-done/workflows/add-todo.md`.

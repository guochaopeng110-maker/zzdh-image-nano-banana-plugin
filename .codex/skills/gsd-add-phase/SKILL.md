...
<execution_context>
@F:/Projects/zz-image-plugins/.codex/get-shit-done/workflows/add-phase.md
</execution_context>
...
<process>
**Follow the add-phase workflow** from `@F:/Projects/zz-image-plugins/.codex/get-shit-done/workflows/add-phase.md`.

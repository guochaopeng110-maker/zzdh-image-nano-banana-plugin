...
<execution_context>
@F:/Projects/zz-image-plugins/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @F:/Projects/zz-image-plugins/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>

...
Knowledge graph is disabled. To activate:
  ...
  node F:/Projects/zz-image-plugins/.claude/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node F:/Projects/zz-image-plugins/.claude/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node F:/Projects/zz-image-plugins/.claude/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```
PREFLIGHT=$(node "F:/Projects/zz-image-plugins/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: F:/Projects/zz-image-plugins/.claude/get-shit-done/bin/gsd-tools.cjs
...
4. **Write diff snapshot:**
   ```
   node \"F:/Projects/zz-image-plugins/.claude/get-shit-done/bin/gsd-tools.cjs\" graphify build snapshot
   ```

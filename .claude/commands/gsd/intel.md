...
Intel system is disabled. To activate:
  ...
  node F:/Projects/zz-image-plugins/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node F:/Projects/zz-image-plugins/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node F:/Projects/zz-image-plugins/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node F:/Projects/zz-image-plugins/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```

...
<execution_context>
@F:/Projects/zz-image-plugins/.claude/get-shit-done/workflows/pr-branch.md
</execution_context>

<process>
Execute the pr-branch workflow from @F:/Projects/zz-image-plugins/.claude/get-shit-done/workflows/pr-branch.md end-to-end.
</process>

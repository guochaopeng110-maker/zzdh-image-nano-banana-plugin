...
<execution_context>
@F:/Projects/zz-image-plugins/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @F:/Projects/zz-image-plugins/.claude/get-shit-done/workflows/docs-update.md end-to-end.

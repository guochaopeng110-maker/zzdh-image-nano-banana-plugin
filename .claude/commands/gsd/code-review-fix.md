...
<execution_context>
@F:/Projects/zz-image-plugins/.claude/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @F:/Projects/zz-image-plugins/.claude/get-shit-done/workflows/code-review-fix.md end-to-end.

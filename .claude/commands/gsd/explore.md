...
<execution_context>
@F:/Projects/zz-image-plugins/.claude/get-shit-done/workflows/explore.md
</execution_context>

<process>
Execute the explore workflow from @F:/Projects/zz-image-plugins/.claude/get-shit-done/workflows/explore.md end-to-end.
</process>

...
<reference>
@F:/Projects/zz-image-plugins/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `F:/Projects/zz-image-plugins/.claude/get-shit-done/references/user-profiling.md` to load:

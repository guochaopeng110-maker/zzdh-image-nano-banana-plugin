...
Reference full template: `F:/Projects/zz-image-plugins/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `F:/Projects/zz-image-plugins/.claude/get-shit-done/templates/state.md`.

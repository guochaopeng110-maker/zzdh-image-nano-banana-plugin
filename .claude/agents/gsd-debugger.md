...
<required_reading>
@F:/Projects/zz-image-plugins/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = F:/Projects/zz-image-plugins/.claude
                  → checks F:/Projects/zz-image-plugins/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = F:/Projects/zz-image-plugins/.claude/get-shit-done
                  → writes to F:/Projects/zz-image-plugins/.claude/get-shit-done/hooks/
...
@F:/Projects/zz-image-plugins/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @F:/Projects/zz-image-plugins/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "F:/Projects/zz-image-plugins/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "F:/Projects/zz-image-plugins/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "F:/Projects/zz-image-plugins/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```

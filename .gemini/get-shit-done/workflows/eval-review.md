...
```bash
AUDITOR_MODEL=$(node "F:/Projects/zz-image-plugins/.gemini/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read F:/Projects/zz-image-plugins/.gemini/agents/gsd-eval-auditor.md for instructions.

...
<!-- For checkpoint task examples and patterns, see @F:/Projects/zz-image-plugins/.gemini/get-shit-done/references/checkpoints.md -->
...
See `F:/Projects/zz-image-plugins/.gemini/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `F:/Projects/zz-image-plugins/.gemini/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `F:/Projects/zz-image-plugins/.gemini/get-shit-done/workflows/verify-phase.md` for verification logic.

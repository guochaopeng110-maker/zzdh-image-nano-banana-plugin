...
- JavaScript package manifests exist only in tooling folders (`.Codex/package.json`, `.agent/package.json`, `.gemini/package.json`) and contain minimal metadata (`{"type":"commonjs"}`).
## Frameworks
